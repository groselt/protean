...
namespace Protean.Test
{
    ...
    public class TestXmlStreams
    {
        ...
        public void TestXmlValidationSuccess()
        {
            ...
            {
                XmlReader xmlReader = XmlReader.Create(xmlStream, XmlMode.Default, true, xsdStream);
        ...
        public void TestXmlValidationFailure()
        {
                ...
                xsdStream = new System.IO.StringReader(c_xsd))
            {
                ...
                Assert.That(() => { xmlReader.Read(); },
                    Throws.InstanceOf<VariantException>().With.Message.StartsWith("Validation Error"));
            }
        }
        ...
        private const string c_validXml = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
        ...
        private const string c_invalidXml = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                                     "<Variant aBoolean=\"true\" aDate=\"2007-01-03\" aDateTime=\"2007-01-03T10:30:00\" aFloat=\"0.5\" aDouble=\"3.9\" aInteger=\"1\" aUnsigned=\"2\" aInt32=\"3\" aUInt32=\"4\" aInt64=\"5\" aUInt64=\"6\" aString=\"Element\" aTime=\"10:30:00\">\n" +
                                     "  <Boolean>true</Boolean>\n" +
                                     "  <Date>2007-01-03</Date>\n" +
                                     "  <DateTime>2007-01-03T10:30:00</DateTime>\n" +
        ...
        private const string c_xsd = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
